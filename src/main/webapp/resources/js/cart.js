$(document).ready(function() {
	...
	addToCart = function(productId){
			$.ajax({
		 		url: '/webstore08TilesWildcardJC/rest/cart/add/' + productId,
		 		type: 'PUT',
				dataType: "json",
	   ...
	   removeFromCart = function(productId) {
			$.ajax({
				url: '/webstore08TilesWildcardJC/rest/cart/remove/'+ productId,
		 		type: 'PUT',
				dataType: "json",
			 	 success: function (response) {
	 ...
	 // Click on Product [row]  in cart
	   ...
	   function showProduct(productId) {
			$.ajax({
				url: '/webstore08TilesWildcardJC/rest/cart/showProduct',
		 		type: 'GET',
		 		async:false,
				dataType: "json",
				data:'id=' + productId,
