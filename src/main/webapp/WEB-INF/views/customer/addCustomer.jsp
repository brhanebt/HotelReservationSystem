...
<h3 class="roomAvail-margin-left">
		<spring:message code="addCustomer.form.title.label" />
</h3>
<form:form modelAttribute="customer" action="/HotelReservationSystem/Customer/add" method="POST"
		class="roomAvail-margin-left">
	...
	<c:forEach items="customer.addresses" var="address" varStatus="status">
		...
		<div class="form-group row">
			<div class="col-sm-6">
				<button type="submit" class="btn btn-primary  mr-1"><spring:message code="form.field.add.label"/></button>
				<button type="reset" class="btn btn-primary  mr-3"><spring:message code="form.field.reset.label"/></button>
			</div>
		</div>
	</form:form>
